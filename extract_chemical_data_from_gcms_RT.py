...
def get_rt_and_name_and_area_from_gcms(xls_filename):
    """
    ...
    for row_index in range(9, number_of_rows):
        ...
        rt_name_area_triple = [rt_value, name_value, area_value]

        
        rt_and_name_and_area_triples.append(rt_name_area_triple)
    return rt_and_name_and_area_triples
